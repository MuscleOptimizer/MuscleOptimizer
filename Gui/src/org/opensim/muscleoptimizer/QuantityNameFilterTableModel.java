/* --------------------------------------------------------------------------*
*          Muscle Optimizer GUI: QuantityNameFilterTableModel.java           *
* -------------------------------------------------------------------------- *
*                                                                            *
...
// Adapted from the OpenSim GUI - plotter source file
// QuantityNameFilterTableModel.java by Ayman Habib
...
import org.opensim.plotter.PlotterSourceInterface;
import org.opensim.plotter.PlotterSourceStringArray;
/**
 *
 * @author Ayman
 */
